package com.seedpool.mvp.utils
...
import com.seedpool.mvp.ImagePreviewActivity
import com.seedpool.mvp.MessageActivity
import com.seedpool.mvp.models.Models
import com.seedpool.mvp.utils.FirebaseUtils.ref.user
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.*
import com.squareup.picasso.Picasso
import com.seedpool.mvp.R
import com.seedpool.mvp.UserProfileActivity
import com.seedpool.mvp.utils.FirebaseUtils.ref.allMessageStatus
        ...
        FirebaseDatabase.getInstance().getReference(key_app_code)
            .addListenerForSingleValueEvent(object : ValueEventListener {
                ...
                override fun onDataChange(p0: DataSnapshot) {
                    ...
                    Log.d("FirebaseUtils", "onDataChange: current version = ${com.seedpool.mvp.BuildConfig.VERSION_CODE}")
                    Log.d("FirebaseUtils", "onDataChange: available version = $versionCode")

                    if(versionCode > com.seedpool.mvp.BuildConfig.VERSION_CODE){
                        //show update dialog
                        context.alert {
